            ...
            <div style={{ background: 'var(--bg-secondary)', borderRadius: '16px', padding: '2rem', boxShadow: 'var(--shadow-hover)' }}>
                ...
                <div style={{ position: 'relative', width: '100%', maxWidth: '600px', margin: '0 auto 3rem auto', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 8px 16px rgba(0,0,0,0.2)' }}>
                    ...
                    <div style={{
                        ...
                        {/* CSS triangle for speech bubble */}
                        <div style={{ position: 'absolute', bottom: '-15px', left: '20px', width: '0', height: '0', borderLeft: '15px solid transparent', borderRight: '15px solid transparent', borderTop: '15px solid black' }} />
                        <div style={{ position: 'absolute', bottom: '-10px', left: '22px', width: '0', height: '0', borderLeft: '11px solid transparent', borderRight: '11px solid transparent', borderTop: '11px solid white' }} />
                    </div>
                </div>
